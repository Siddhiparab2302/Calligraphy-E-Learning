...
if(isset($_REQUEST['requpdate'])){
    ...
    course_price = '$cprice',course_org_price = '$corgprice',course_img = '$cimg'
    WHERE course_id = '$cid'";
...
<div class="col-sm-6 mt-5 mx-4 jumbotron">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="course_org_price" name="course_org_price" value="<?php if(isset($row['course_org_price'])) 
